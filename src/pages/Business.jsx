...
export default function Business(){
    ...
    return(
        <div onClick={(e) => {
            ...
            <p className='center-aligned-text' style={{marginLeft: "400px", marginRight: "300px"}}>The Business team is responsible for securing funding from Cornell and external donors.</p>
            <p className='center-aligned-text' style={{marginLeft: "400px", marginRight: "300px"}}>They also doubled as web developers in Spring 2026, so they're simply the best subteam.</p>
