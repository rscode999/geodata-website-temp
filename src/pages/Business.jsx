...
import businessLogo from '../assets/images/subteam_logos/business.png';
...
export default function Business(){
    ...
    return(
        <div onClick={(e) => {
            ...
            <p className='left-aligned-text-large-margin'>The Business team is responsible for securing funding from Cornell and external donors.</p>
            <p className='left-aligned-text-large-margin'>They also doubled as web developers in Spring 2026, so they're simply the best subteam.</p>
