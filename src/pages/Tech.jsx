...
export default function Tech(){
  ...
  return(
      <div onClick={(e) => {
        ...
        <p className='center-aligned-text'>The Tech Team is Geodata's support arm. A small and tight-knit team, Tech builds custom parts for other subteams, such as parts for weather stations and sensors.</p>
        <p className='center-aligned-text-text'>They often use 3D printers, Arduinos, soldering sets, and lots of duct tape to build their creations.</p>
